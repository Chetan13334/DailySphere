        ...
        <div className="w-full max-w-[440px] z-10">
          ...
          >
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {error && (
                <div className="rounded-lg bg-red-500/10 p-3 text-center text-xs font-semibold text-red-500 border border-red-500/20">
                  {error}
                </div>
              )}
              ...
              <button
                className="primary-gradient group flex w-full items-center justify-center rounded-lg px-6 py-4 font-headline font-bold text-white shadow-lg transition-all duration-200 hover:shadow-xl active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                type="submit"
                disabled={loading}
              >
                {loading ? "Signing In..." : "Sign In to Dashboard"}
                {!loading && <span className="material-symbols-outlined ml-2 transition-transform group-hover:translate-x-1">arrow_forward</span>}
              </button>
            </form>
