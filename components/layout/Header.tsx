...
type HeaderActive = "dashboard" | "weather" | "holidays" | "currency" | "reminders" | "profile";
  ...
  return (
    <header className="sticky top-0 z-50 border-none bg-[#f8f9fa]">
      <div className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-8 py-4">
        <Link href={ROUTES.dashboard} className="font-headline text-2xl font-bold tracking-tighter text-[#041627]">
          DailySphere
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href={ROUTES.profile} className="flex items-center gap-3 border-l border-[#c4c6cd]/15 pl-4 transition-colors hover:text-[#041627]">
