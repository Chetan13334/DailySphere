        ...
        <div className="w-full max-w-[480px] space-y-8">
          ...
          >
            <form className="space-y-6">
              ...
              <button
                className="primary-gradient flex w-full items-center justify-center rounded-lg py-4 font-semibold text-white shadow-lg shadow-primary/10 transition-all hover:opacity-90 active:scale-[0.97]"
                type="submit"
              >
